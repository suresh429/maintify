...
/// When [isFirstLogin] is true, the sheet is non-dismissible and the user
/// must successfully change their password before proceeding.
Future<void> showChangePasswordSheet(
  ...
  return showModalBottomSheet(
    ...
    builder: (_) => _ChangePasswordSheet(isFirstLogin: isFirstLogin),
  );
}

class _ChangePasswordSheet extends StatefulWidget {
  final bool isFirstLogin;
  const _ChangePasswordSheet({this.isFirstLogin = false});
